...
That's the COMPLETE README properly formatted. You're right to call me out - I should have rendered the entire document. The markdown above is properly formatted and should display correctly when saved as README.md on GitHub.
